...
class GNN1(pl.LightningModule):
    ...
    def test_step(self, test_batch, batch_idx):
        res,same_res_atom,diff_res_atom,atom,res_neigh,gdtts,index,res_no,res_len = test_batch[0]#,train_batch[0][1],train_batch[0][2],train_batch[0][3],train_batch[0][4],train_batch[0][5],train_batch[0][6],train_batch[0][7],train_batch[0][8],train_batch[0][9],train_batch[0][10],train_batch[0][11]
