...
if  __name__ == "__main__":
    ...
    label_file_train="Train.npy"
    label_file_val="Val.npy"
    label_file_test="Test_CASP13.npy"
    ...
    temp=data1(path_res_trans,same_res_atom_neigh,diff_res_atom_neigh,atom_one_hot,res_neigh,gdtts,gdtha,tmscore,gcad,lcad,batch_size,workers,label_file_train,label_file_val,label_file_test,res_no)
