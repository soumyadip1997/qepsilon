...
if  __name__ == "__main__":
    ...
    Val_label_file="Val.npy"
    Train_label_file="Temp_Train.npy"
    Test_label_file="Test_CASP14_GEO.npy"
    ...
    res_no="/s/lovelace/c/nobackup/asa/soumya16/QA_project/Features/Atomfreq/atomfreq_"


    temp=data1(path_res_trans,same_res_atom_neigh,diff_res_atom_neigh,atom_one_hot,res_neigh,gdtts,gdtha,tmscore,gcad,lcad,batch_size,workers,Train_label_file,Val_label_file,Test_label_file,res_no)
    ...
    # model
    path1=glob.glob("lightning_logs/version_3182/checkpoints/epoch=9*.ckpt")
    print(path1[0])
