...
class data1:
    def __init__(self,transformer,same_res_atom_neigh,diff_res_atom_neigh,atom_one_hot,res_neigh,gdtts,gdtha,tmscore,gcad,lcad,batch_size,workers,label_file_train,label_file_val,label_file_test,res_no):
